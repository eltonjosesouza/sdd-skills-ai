...
export class ScrumService {
  private static readonly SCRUM_AGENTS = [
    {
      name: "Product Owner",
      skill: SCRUM_PRODUCT_OWNER_SKILL,
      id: "scrum.product-owner",
    },
    {
      name: "Scrum Master",
      skill: SCRUM_SCRUM_MASTER_SKILL,
      id: "scrum.scrum-master",
    },
    ...
    {
      name: "UX Designer",
      skill: SCRUM_UX_DESIGNER_SKILL,
      id: "scrum.ux-designer",
    },
    {
      name: "QA Engineer",
      skill: SCRUM_QA_ENGINEER_SKILL,
      id: "scrum.qa-engineer",
    },
    {
      name: "Security Engineer",
      skill: SCRUM_SECURITY_ENGINEER_SKILL,
      id: "scrum.security-engineer",
    },
    {
      name: "DevOps Engineer",
      skill: SCRUM_DEVOPS_ENGINEER_SKILL,
      id: "scrum.devops-engineer",
    },
  ...
  private static readonly SCRUM_SKILLS = [
    {
      name: "SDD Contract",
      skill: SCRUM_SDD_CONTRACT_SKILL,
      id: "scrum.sdd-contract",
    },
    { name: "TDD Cycle", skill: SCRUM_TDD_CYCLE_SKILL, id: "scrum.tdd-cycle" },
    {
      name: "DDD Modeling",
      skill: SCRUM_DDD_MODELING_SKILL,
      id: "scrum.ddd-modeling",
    },
    {
      name: "Telemetry Design",
      skill: SCRUM_TELEMETRY_DESIGN_SKILL,
      id: "scrum.telemetry-design",
    },
    {
      name: "Scrum Flow",
      skill: SCRUM_SCRUM_FLOW_SKILL,
      id: "scrum.scrum-flow",
    },
    {
      name: "Communication",
      skill: SCRUM_COMMUNICATION_SKILL,
      id: "scrum.communication",
    },
    {
      name: "DoD Checklist",
      skill: SCRUM_DOD_CHECKLIST_SKILL,
      id: "scrum.dod-checklist",
    },
    {
      name: "Phase 1: Discovery",
      skill: SCRUM_01_DISCOVERY_SKILL,
      id: "scrum.01-discovery",
    },
    {
      name: "Phase 2: Contract",
      skill: SCRUM_02_CONTRACT_SKILL,
      id: "scrum.02-contract",
    },
    {
      name: "Phase 3: Sprint Planning",
      skill: SCRUM_03_SPRINT_PLANNING_SKILL,
      id: "scrum.03-sprint-planning",
    },
    {
      name: "Phase 4: Development",
      skill: SCRUM_04_DEVELOPMENT_SKILL,
      id: "scrum.04-development",
    },
    {
      name: "Phase 5: Validation",
      skill: SCRUM_05_VALIDATION_SKILL,
      id: "scrum.05-validation",
    },
    {
      name: "Phase 6: Release",
      skill: SCRUM_06_RELEASE_SKILL,
      id: "scrum.06-release",
    },
  ];
  ...
  private static readonly SCRUM_WORKFLOWS = [
    {
      ...
      workflow: SCRUM_FEATURE_LIFECYCLE_WORKFLOW,
      id: "scrum.feature-lifecycle",
    },
    {
      name: "Sprint Planning",
      workflow: SCRUM_SPRINT_PLANNING_WORKFLOW,
      id: "scrum.sprint-planning",
    },
    {
      name: "Install Scrum Agents",
      workflow: SCRUM_INSTALL_SCRUM_AGENTS_WORKFLOW,
      id: "scrum.install-scrum-agents",
    },
    {
  ...
  private static createSkillFile(
    projectPath: string,
    skill: { name: string; skill: string; id: string },
  ): void {
  ...
  private static createWorkflowFile(
    projectPath: string,
    workflow: { name: string; workflow: string; id: string },
  ): void {
  ...
  private static installScrumAgentsComponents(projectPath: string): string[] {
    ...
    for (const agent of ScrumService.SCRUM_AGENTS) {
      try {
        ...
        console.error(
          chalk.red(`   ❌ Failed to install ${agent.name}: ${error}`),
        );
        throw error;
      }
    }
  ...
  private static installScrumSkillsComponents(projectPath: string): string[] {
    ...
    for (const skill of ScrumService.SCRUM_SKILLS) {
      try {
        ...
        console.error(
          chalk.red(`   ❌ Failed to install ${skill.name}: ${error}`),
        );
        throw error;
      }
    }
  ...
  private static installScrumWorkflowsComponents(
    projectPath: string,
  ): string[] {
    ...
    for (const workflow of ScrumService.SCRUM_WORKFLOWS) {
      try {
        ...
        console.error(
          chalk.red(`   ❌ Failed to install ${workflow.name}: ${error}`),
        );
        throw error;
      }
    }
  ...
  public static async installScrumAgents(
    projectDirectory?: string,
  ): Promise<ScrumInstallationResult> {
    ...
    try {
      const installedAgents =
        ScrumService.installScrumAgentsComponents(projectPath);
      const installedSkills =
        ScrumService.installScrumSkillsComponents(projectPath);
      const installedWorkflows =
        ScrumService.installScrumWorkflowsComponents(projectPath);
      ...
      console.log(
        chalk.cyan(`   🔄 ${installedWorkflows.length} Scrum Workflows`),
      );
      console.log(chalk.white(`\n🎯 Ready to use:`));
      console.log(
        chalk.cyan(
          `   @scrum.product-owner - For requirements and backlog management`,
        ),
      );
      console.log(chalk.cyan(`   @scrum.developer - For TDD implementation`));
      console.log(
        chalk.cyan(
          `   /scrum.feature-lifecycle - For complete feature development`,
        ),
      );
  ...
  public static getScrumStats(): {
    ...
    return {
      ...
      totalComponents:
        ScrumService.SCRUM_AGENTS.length +
        ScrumService.SCRUM_SKILLS.length +
        ScrumService.SCRUM_WORKFLOWS.length,
    };
  }
  ...
  public static getScrumComponents(): {
    ...
    return {
      agents: ScrumService.SCRUM_AGENTS.map((agent) => ({
        id: agent.id,
        name: agent.name,
      })),
      skills: ScrumService.SCRUM_SKILLS.map((skill) => ({
        id: skill.id,
        name: skill.name,
      })),
      workflows: ScrumService.SCRUM_WORKFLOWS.map((workflow) => ({
        id: workflow.id,
        name: workflow.name,
      })),
    };
